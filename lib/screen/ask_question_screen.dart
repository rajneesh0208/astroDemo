            ...
            ? SizedBox(
                ...
                child: Column(
                  children: [
                              ...
                              child: DropdownButtonHideUnderline(
                                child: DropdownButton(
                                  ...
                                  onChanged: (newValue) async {
                                    ...
                                    await askQuestionProvider.categoryId(int.parse(newValue.toString()));
                    ...
                    Column(
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            border: Border.all(
                                color: ColorConstant.bottomGrey, width: 1.5),
                            borderRadius: BorderRadius.circular(10),
                          ),
                          child: TextField(
                    ...
                    askQuestionProvider.suggestionList != null?  Container(
                      width: w,
                      margin: EdgeInsets.symmetric(
                          vertical: 20, horizontal: w * 0.05),
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          const Text("Ideas what to ask(Select Any)",
                              style: TextStyle(
                                  fontSize: 20,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.black)),
                          Container(
                            ...
                            child: ListView.builder(
                              itemBuilder: (context, index) {
                                return Container(
                                  ...
                                  child: Column(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      Text(". ${askQuestionProvider.suggestionList![index]}"),
                              ...
                              itemCount: askQuestionProvider.suggestionList!.length,
                              shrinkWrap: true,
